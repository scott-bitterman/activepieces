...
const triggerNameInStore = 'knack_record_delete_trigger';

export const recordDeleteWebHook = createTrigger({
  auth,
  name: 'record-delete-webhook',
  displayName: 'Record Delete - Webhook',
  description: 'Triggers when a record is deleted from a Knack table',
  props: {
