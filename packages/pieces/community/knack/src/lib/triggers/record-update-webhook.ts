...
const triggerNameInStore = 'knack_record_update_trigger';

export const recordUpdateWebHook = createTrigger({
  auth,
  name: 'record-update-webhook',
  displayName: 'Record Update - Webhook',
  description: 'Triggers when a record is updateed into a Knack table',
  props: {
